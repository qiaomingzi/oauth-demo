...
<html>
<head>
    <title>Test [${clientDetailsDto.appKey}]</title>
...
<div ng-app>
    ...
    <h2>Test [${clientDetailsDto.appKey}]</h2>
...
<script>
    var TestClientCtrl = ["$scope", function ($scope) {
        $scope.clientId = "${clientDetailsDto.appKey}";
        $scope.clientSecret = "${clientDetailsDto.appSecret}";
        ...
        $scope.redirectUri = "http://localhost:9402${contextPath}/unity/dashboard";
        </c:if>
