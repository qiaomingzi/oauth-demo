...
<form:form commandName="formDto" cssClass="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:input path="account" cssClass="form-control" placeholder="Type account"
                        required="required"/>

            <p class="help-block">account, unique.</p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:input path="tel" cssClass="form-control" placeholder="Type tel"/>

            <p class="help-block">User tel, optional.</p>
        </div>
    </div>
    <div class="form-group">
