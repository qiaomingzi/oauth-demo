...
import com.monkeyk.sos.web.validator.OauthClientDetailsDtoValidator;
...
public class ClientDetailsController {
    ...
    public String clientDetails(Model model) {
        List<Application> clientDetailsDtoList = oauthService.loadAllOauthClientDetailsDtos();
    ...
    * */
    ...
    public String testClient(@PathVariable("clientId") String clientId, Model model) {
        Application clientDetailsDto = oauthService.loadOauthClientDetailsDto(clientId);
    ...
    * */
    ...
    public String registerClient(Model model) {
        model.addAttribute("formDto", new Application());
    ...
    * */
    ...
    public String submitRegisterClient(@ModelAttribute("formDto") Application formDto, BindingResult result) {
