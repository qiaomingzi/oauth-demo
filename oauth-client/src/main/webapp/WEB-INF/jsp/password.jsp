...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="col-md-10" ng-controller="PasswordCtrl">
            ...
            <form class="form-horizontal" action="${accessTokenUri}" method="post" target="targetObj">
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">获取accessToken</button>
                <span class="label label-warning">POST</span>
            </form>
        </div>
    </div>
</div>
<iframe height="0" width="0" src="" id="targetObj"></iframe>
<script>
    var PasswordCtrl = ['$scope', function ($scope) {
        $scope.clientId = "password-app";
        $scope.clientSecret = "password-app-secret";
        $scope.grantType = "password";

        $scope.username = "admin";
        $scope.password = "q1w2e3r4";
